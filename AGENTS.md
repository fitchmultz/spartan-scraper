...
- Keep validation and enablement material secondary to the real product path. Top-level docs should send readers through README → demo → validation checklist before optional enablement guides.
