...
If you discover a security vulnerability, please report it privately to us at:

[security-contact@spartan-scraper.dev](mailto:security-contact@spartan-scraper.dev)  
*(Contact details to be updated when project goes public)*
...
- **Robots.txt compliance**: Robots.txt is intentionally ignored by design. This is a feature, not a vulnerability.
