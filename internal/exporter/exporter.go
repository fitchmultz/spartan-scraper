// Package exporter provides functionality for exporting job results to the
// supported Balanced 1.0 formats.
//
// This package supports JSON, JSONL, Markdown, CSV, and XLSX output formats
// with both buffered and streaming interfaces for memory-efficient processing
// of large results.
//
// Public API:
