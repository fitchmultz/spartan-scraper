// Package fetch provides tests for HTTP fetcher response size limits.
// Tests cover MaxResponseBytes enforcement and error message formatting.
// Does NOT test network-level size constraints or chunked encoding.
package fetch
