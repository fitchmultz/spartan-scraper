...
func TestResearchSchema(t *testing.T) {
	...
	for _, field := range []string{"maxDepth", "maxPages", "headless", "playwright", "timeoutSeconds", "authProfile", "auth", "extract", "pipeline", "webhook", "screenshot", "device", "networkIntercept", "agentic"} {
