...
func TestValidateChainDefinition(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			def: ChainDefinition{
				Nodes: []ChainNode{
					{ID: "a", Kind: KindScrape, Params: []byte(`{"url":"http://example.com"}`)},
					{ID: "b", Kind: KindScrape, Params: []byte(`{"url":"http://example.com/2"}`)},
				},
				Edges: []ChainEdge{
					{From: "a", To: "b"},
				},
		...
		},
		{
			...
			def: ChainDefinition{
				Nodes: []ChainNode{
					{ID: "a", Kind: KindScrape, Params: []byte(`{"url":"http://example.com"}`)},
					{ID: "b", Kind: KindScrape, Params: []byte(`{"url":"http://example.com/2"}`)},
					{ID: "c", Kind: KindScrape, Params: []byte(`{"url":"http://example.com/3"}`)},
					{ID: "d", Kind: KindCrawl, Params: []byte(`{"url":"http://example.com/4"}`)},
				},
				Edges: []ChainEdge{
					{From: "a", To: "b"},
					{From: "a", To: "c"},
		...
		},
		{
			...
			def: ChainDefinition{
				Nodes: []ChainNode{
					{ID: "", Kind: KindScrape, Params: []byte(`{"url":"http://example.com"}`)},
				},
				Edges: []ChainEdge{},
			},
			wantErr: true,
		...
		},
		{
			...
			def: ChainDefinition{
				Nodes: []ChainNode{
					{ID: "a", Kind: KindScrape, Params: []byte(`{"url":"http://example.com"}`)},
					{ID: "a", Kind: KindCrawl, Params: []byte(`{"url":"http://example.com/2"}`)},
				},
				Edges: []ChainEdge{},
			},
			wantErr: true,
...
func TestChainDefinitionGetRootNodes(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			def: ChainDefinition{
				Nodes: []ChainNode{
					{ID: "a", Kind: KindScrape, Params: []byte(`{}`)},
					{ID: "b", Kind: KindScrape, Params: []byte(`{}`)},
					{ID: "c", Kind: KindScrape, Params: []byte(`{}`)},
				},
				Edges: []ChainEdge{
					{From: "a", To: "b"},
					{From: "b", To: "c"},
		...
		},
		{
			...
			def: ChainDefinition{
				Nodes: []ChainNode{
					...
					{ID: "b", Kind: KindScrape, Params: []byte(`{}`)},
					{ID: "c", Kind: KindScrape, Params: []byte(`{}`)},
					{ID: "d", Kind: KindCrawl, Params: []byte(`{}`)},
				},
				Edges: []ChainEdge{
					{From: "a", To: "b"},
					{From: "a", To: "c"},
		...
		},
		{
			...
			def: ChainDefinition{
				Nodes: []ChainNode{
					{ID: "a", Kind: KindScrape, Params: []byte(`{}`)},
					{ID: "b", Kind: KindScrape, Params: []byte(`{}`)},
					{ID: "c", Kind: KindCrawl, Params: []byte(`{}`)},
				},
				Edges: []ChainEdge{
					{From: "a", To: "c"},
					{From: "b", To: "c"},
