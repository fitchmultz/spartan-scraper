	...
	chain := model.JobChain{
		...
		Definition: model.ChainDefinition{
			Nodes: []model.ChainNode{
				{ID: "node1", Kind: model.KindScrape, Request: []byte(`{"url":"http://example.com"}`)},
				{ID: "node2", Kind: model.KindCrawl, Request: []byte(`{"url":"http://example.com/2"}`)},
			},
...
func TestGetChainByName(t *testing.T) {
	...
	chain := model.JobChain{
		...
		Definition: model.ChainDefinition{
			Nodes: []model.ChainNode{
				{ID: "node1", Kind: model.KindScrape, Request: []byte(`{}`)},
			},
			Edges: []model.ChainEdge{},
		},
		CreatedAt: time.Now(),
...
func TestUpdateChain(t *testing.T) {
	...
	chain.Definition.Nodes = append(chain.Definition.Nodes, model.ChainNode{
		ID: "node2", Kind: model.KindCrawl, Request: []byte(`{}`),
	})
	...
	chains := []model.JobChain{
		{
			...
			Name: "Alpha Chain",
			Definition: model.ChainDefinition{
				Nodes: []model.ChainNode{{ID: "n1", Kind: model.KindScrape, Request: []byte(`{}`)}},
				Edges: []model.ChainEdge{},
			},
		...
		},
		{
			...
			Name: "Beta Chain",
			Definition: model.ChainDefinition{
				Nodes: []model.ChainNode{{ID: "n2", Kind: model.KindCrawl, Request: []byte(`{}`)}},
				Edges: []model.ChainEdge{},
			},
		...
		},
		{
			...
			Name: "Gamma Chain",
			Definition: model.ChainDefinition{
				Nodes: []model.ChainNode{{ID: "n3", Kind: model.KindResearch, Request: []byte(`{}`)}},
				Edges: []model.ChainEdge{},
			},
			CreatedAt: time.Now(),
			UpdatedAt: time.Now(),
