// Package system provides system functionality for Spartan Scraper.
//
// Purpose:
// - Verify submission parity test behavior for package system.
//
// Responsibilities:
...
//
// Usage:
// - Run with `go test` for package `system` or through `make test-ci`/`make ci`.
//
