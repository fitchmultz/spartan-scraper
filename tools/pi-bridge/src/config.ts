/**
 * Purpose: Implement the pi bridge config module.
...
export function defaultRoutes(): Record<string, string[]> {
  return {
    ...
    [CAPABILITY_RESEARCH_REFINE]: [...DEFAULT_ROUTE_ORDER],
    [CAPABILITY_EXPORT_SHAPE]: [...DEFAULT_ROUTE_ORDER],
    [CAPABILITY_TRANSFORM_GENERATE]: [...DEFAULT_ROUTE_ORDER],
  };
}
