 ...
 * Invariants/Assumptions: Empty sections should still explain what the capability is for and what to do next.
 */
      ...
      {isCompletelyEmpty ? (
        <section className="panel info-section">
          <ActionEmptyState
            ...
            title="Nothing needs maintenance yet"
            description="These sections fill in as you create reusable auth, schedule recurring work, and run incremental crawls. Start with a successful job, then come back here when reuse matters."
            actions={[
        ...
        >
          {crawlStates.length === 0 ? (
            <ActionEmptyState
              ...
              actions={[
                { label: "Create crawl job", onClick: onCreateJob },
                {
                  label: "Open automation",
                  onClick: onOpenAutomation,
                  tone: "secondary",
              ...
              {crawlStatesTotal > crawlStatesPerPage ? (
                ...
                >
                  ...
                  <span className="pagination-info">
                    Page {crawlStatesPage} of {maxPage} ({crawlStatesTotal}{" "}
                    total)
                  </span>
                  ...
                  <div className="pagination-jump">
                    <input
                      ...
                      onChange={(event) =>
                        setJumpInputValue(event.target.value)
                      }
                    />
                    <button
                      type="button"
